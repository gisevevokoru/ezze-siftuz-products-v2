...
namespace EzzeSiftuz\ProductsV2\Api;
...
use EzzeSiftuz\ProductsV2\HeaderSelector;
...
class ProductActiveStatusApi
{
     ...
     *
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EzzeSiftuz\ProductsV2\Model\ActiveStatusListResponse
     */
    public function getActiveStatus($sku = null, $product_reference = null, $category = null, $brand = null, $page = null, $limit = null)
    {
        list($response) = $this->getActiveStatusWithHttpInfo($sku, $product_reference, $category, $brand, $page, $limit);
        return $response;
    }
     ...
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\ProductsV2\Model\ActiveStatusListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getActiveStatusWithHttpInfo($sku = null, $product_reference = null, $category = null, $brand = null, $page = null, $limit = null)
    {
        $returnType = '\EzzeSiftuz\ProductsV2\Model\ActiveStatusListResponse';
        $request = $this->getActiveStatusRequest($sku, $product_reference, $category, $brand, $page, $limit);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ProductsV2\Model\ActiveStatusListResponse',
     ...
     */
    public function getActiveStatusAsync($sku = null, $product_reference = null, $category = null, $brand = null, $page = null, $limit = null)
    {
        return $this->getActiveStatusAsyncWithHttpInfo($sku, $product_reference, $category, $brand, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getActiveStatusAsyncWithHttpInfo($sku = null, $product_reference = null, $category = null, $brand = null, $page = null, $limit = null)
    {
        $returnType = '\EzzeSiftuz\ProductsV2\Model\ActiveStatusListResponse';
        $request = $this->getActiveStatusRequest($sku, $product_reference, $category, $brand, $page, $limit);
     ...
     */
    protected function getActiveStatusRequest($sku = null, $product_reference = null, $category = null, $brand = null, $page = null, $limit = null)
    {
     ...
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EzzeSiftuz\ProductsV2\Model\ActiveStatus
     */
     ...
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\ProductsV2\Model\ActiveStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVariationActiveStatusWithHttpInfo($sku)
    {
        $returnType = '\EzzeSiftuz\ProductsV2\Model\ActiveStatus';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ProductsV2\Model\ActiveStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \EzzeSiftuz\ProductsV2\Model\ActiveStatusListRequest $body body (optional)
     * @param  string $x_request_timestamp Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     *
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EzzeSiftuz\ProductsV2\Model\ProductProcessProgress
     */
     ...
     * Update the active status of your product variations and get a process-id to query results.
     *
     * @param  \EzzeSiftuz\ProductsV2\Model\ActiveStatusListRequest $body (optional)
     * @param  string $x_request_timestamp Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     *
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\ProductsV2\Model\ProductProcessProgress, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateActiveStatusWithHttpInfo($body = null, $x_request_timestamp = null)
    {
        $returnType = '\EzzeSiftuz\ProductsV2\Model\ProductProcessProgress';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ProductsV2\Model\ProductProcessProgress',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;

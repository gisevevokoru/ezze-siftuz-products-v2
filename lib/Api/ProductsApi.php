...
class ProductsApi
{
     ...
     *
     * @param  \EzzeSiftuz\ProductsV2\Model\ProductVariation[] $body body (optional)
     ...
     * Create or update your product variations and get a process-id to query results. The limit for the number of product variations in one request is 500.
     *
     * @param  \EzzeSiftuz\ProductsV2\Model\ProductVariation[] $body (optional)
     * @param  \DateTime $x_request_timestamp Holds the client side update request timestamp (optional)
     *
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EzzeSiftuz\ProductsV2\Model\ProductProcessResult
     */
     ...
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\ProductsV2\Model\ProductProcessResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function failedByProcessIdWithHttpInfo($process_uuid)
    {
        $returnType = '\EzzeSiftuz\ProductsV2\Model\ProductProcessResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ProductsV2\Model\ProductProcessResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EzzeSiftuz\ProductsV2\Model\ProductVariationApiResult
     */
     ...
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\ProductsV2\Model\ProductVariationApiResult, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\EzzeSiftuz\ProductsV2\Model\ProductVariationApiResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ProductsV2\Model\ProductVariationApiResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EzzeSiftuz\ProductsV2\Model\ProductVariation
     */
     ...
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\ProductsV2\Model\ProductVariation, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductVariationWithHttpInfo($sku)
    {
        $returnType = '\EzzeSiftuz\ProductsV2\Model\ProductVariation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ProductsV2\Model\ProductVariation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;

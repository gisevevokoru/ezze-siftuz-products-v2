...
class MarketplaceStatusApi
{
     ...
     * @return \EzzeSiftuz\ProductsV2\Model\MarketPlaceStatus
     */
     ...
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\ProductsV2\Model\MarketPlaceStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMarketPlaceStatusWithHttpInfo($sku)
    {
        $returnType = '\EzzeSiftuz\ProductsV2\Model\MarketPlaceStatus';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ProductsV2\Model\MarketPlaceStatus',
     ...
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EzzeSiftuz\ProductsV2\Model\MarketPlaceStatusApiResult
     */
     ...
     * @throws \EzzeSiftuz\ProductsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\ProductsV2\Model\MarketPlaceStatusApiResult, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\EzzeSiftuz\ProductsV2\Model\MarketPlaceStatusApiResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ProductsV2\Model\MarketPlaceStatusApiResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
